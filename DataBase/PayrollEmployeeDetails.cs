...
namespace PayrollParrots.DataBase
{
    public class PayrollEmployeeDetails
    {
        ...
        public static void InsertPayrollData(Context context, Payroll payroll, string Email)
        {
        ...
        public static Payroll SelectPayroll(Context context, int payrollId, string Email)
        {
            Payroll payroll;
        ...
        public static List<Payroll> GetPayrollList(Context context, string Email)
        {
        ...
        public static void DeletePayroll(Context context, Payroll payroll, string Email)
        {
            SQLiteDatabase db = new DataStore(context, Email).WritableDatabase;
