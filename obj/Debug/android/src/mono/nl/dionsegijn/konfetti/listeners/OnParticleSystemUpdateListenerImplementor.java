...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("NL.DionSegijn.Konfetti.Listeners.IOnParticleSystemUpdateListenerImplementor, DanielMartinus.Konfetti", OnParticleSystemUpdateListenerImplementor.class, __md_methods);
	}
	...
	public OnParticleSystemUpdateListenerImplementor ()
	{
		...
		if (getClass () == OnParticleSystemUpdateListenerImplementor.class)
			mono.android.TypeManager.Activate ("NL.DionSegijn.Konfetti.Listeners.IOnParticleSystemUpdateListenerImplementor, DanielMartinus.Konfetti", "", this, new java.lang.Object[] {  });
	}
